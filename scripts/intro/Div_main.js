function Div_main() {
	...
	return (
		<main class="pb-16 lg:pb-24 bg-white antialiased">
			...
			<div class="flex relative z-20 justify-between p-6 -m-36 mx-4 bg-white rounded xl:-m-32 xl:mx-auto">
				<article class="lg:w-[600px] w-full max-w-none format format-sm sm:format-base lg:format-lg format-blue">
